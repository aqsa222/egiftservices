				...
				<form action="" method="post">
					...
					<div class="input-group">
			        	<input type="email" class="form-control" placeholder="<?php echo LANG_VALUE_95; ?>" name="email_subscribe">
			         	...
			         	<button class="btn btn-theme" type="submit" name="form_subscribe"><?php echo LANG_VALUE_92; ?></button><br><br>
						<div class="col-md-5 right">
				<ul>
						<!--<li><a href="PostAd.php"><i class="fa fa-upload"></i>Post Ad.</a></li>-->
						<li><a href="createblog.php"><i class="fa fa-pencil-square"></i>Create Blog</a></li></div></ul>
...
<div class="footer-bottom" align="center" >
 ...
 <p>E-Gift Services<br>
 <a href="index.php">Home</a></p>
  <!--<a href="blogs.php">Blogs</a></p>-->
  <a href="faq.php">fAQs</a></p>
